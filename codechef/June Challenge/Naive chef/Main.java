...
public class Main{
    ...
    static void solve(FastReader in){
       ...
       while(t-- > 0){
        ...
        int two = 0;
        /*
            At first you will think that this problem can be solved by taking a and b. And
            counting the unique integers. Then just dividing (a * b) / (no. of unique elements raise to the power 2)
            But this will give incorrect precision and except the sample test case all the test case will be failed
        */
        for(int i = 0; i < n; i++) {
            double check = in.nd();
            if(check == a) one++;
