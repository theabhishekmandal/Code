...
class UnrolledLinkedList<E> extends AbstractList<E> implements List<E>, Serializable{
    ...
    private class ULLIterator implements ListIterator<E>{
        ...
        // pointer to the list
        int index;
        // modCount is present in AbstractList
    ...
    private void insertIntoNode(ListNode node, int ptr, E element){
        ...
        if(node.numElements == nodeCapacity){
            ...
            // inserting this way because there is a possiblity that the node.next might not be null
...
public class Main{
    public static void main(String args[]){
        UnrolledLinkedList<String> list = new UnrolledLinkedList<>();
    }
}
